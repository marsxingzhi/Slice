 ...
 *
 * 也不一定需要设置特殊值，根据MixinProxyInsn的internal name判断也行
 *
 * 示例：
 * class HelloWorld1 {
 *
 *     public static int hookLogW(String tag, String msg) {
 *         int value = (int) MixinProxyInsn.proceed(tag, msg + " ---> TestMixin hook hookLogW success.");
 *         return value;
 *     }
 *
 *     public static int hookLogW_1(String tag, String msg) {
 *         return MixinProxyInsn.proceed1(tag, msg + " ---> hook success");
 *     }
 * }
 *
 * 上述两个方法对应的指令区别：
 *
 * 方法一：
 * il.add(new MethodInsnNode(INVOKESTATIC, "run/test/MixinProxyInsn", "proceed", "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/Object;", false));
 ...
 *
 * 方法二：
 * il.add(new MethodInsnNode(INVOKESTATIC, "run/test/MixinProxyInsn", "proceed1", "(Ljava/lang/String;Ljava/lang/String;)I", false));
 *
